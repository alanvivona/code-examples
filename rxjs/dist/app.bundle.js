...
/***/ function(module, exports, __webpack_require__) {
	...
	var posts = [{ title: 'Post one', body: 'body one' }, { title: 'Post two', body: 'body two' }, { title: 'Post three', body: 'body three' }, { title: 'Post four', body: 'body four' }];

	var posts$ = _Rx2.default.Observable.from(posts);
	posts$.subscribe(function (post) {
		console.log(post);
		document.querySelector('#posts').innerHTML = document.querySelector('#posts').innerHTML + '<li>' + '<h3>' + post.title + '</h3>' + '<p>' + post.body + '</p>' + '</li>';
	}, function (err) {
		console.log(err);
	});
	...
	var source$ = new _Rx2.default.Observable(function (observer) {
		...
		setTimeout(function () {
			return observer.next('Last value');
		}, 2000);
